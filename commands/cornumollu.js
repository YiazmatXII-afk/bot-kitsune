...
module.exports.run = async (bot, message, args) => {
    ...
    let role = message.guild.roles.find(r => r.name === "Cornu Mollu");
    ...
    let embed = new Discord.RichEmbed()
        ...
        .addField("Moderation:", "cornumollu")
...
module.exports.config = {
    name: "cornumollu",
    description: "Adds the role Cornu Mollu to a member",
    usage: "!cornumollu <(@mention)>",
    accessableby: "Admin",
    aliases: ["cm"]
}
