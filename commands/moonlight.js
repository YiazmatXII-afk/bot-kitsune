...
module.exports.run = async (bot, message, args) => {
    ...
    let role = message.guild.roles.find(r => r.name === "Moon Light");
...
module.exports.config = {
    name: "moonlight",
    description: "Adds the role Moon Light to a member",
    usage: "!moonlight <(@mention)>",
    accessableby: "Admin",
    aliases: ["ml"]
}
